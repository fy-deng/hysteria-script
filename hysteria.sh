...
inst_hy(){
    ...
    wget -N https://raw.githubusercontent.com/fy-deng/hysteria-script/main/install_server.sh
...
rules:
  ...
  - MATCH,Proxy
EOF
    url="hysteria://$hy_ym:$port?protocol=$protocol&auth=$auth_pwd&peer=$domain&insecure=$true&upmbps=10&downmbps=50&alpn=h3#Hysteria"
